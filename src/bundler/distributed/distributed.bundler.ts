...
export class DistributedBundler {
    ...
    public constructor(
        ...
        public config: DistributedBundlerConfig = {}
    ) {
        this.dirs = {} as any;
    }

    public async run() {
        Console.header('Distributed Bundler');

        Log.info('bundler', 'distributed', `Importing the Distributed definition from ${this.appPath}`)
